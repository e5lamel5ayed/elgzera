                    ...
                    <div className="card-body">
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <label htmlFor="statusId" className="d-flex">نوع التذكرة</label>
                                    <TextField
                                        id="statusId"
                                        name="statusId"
                                        select
                                    ...
                                    >
                                        ...
                                        <option value="1">تذاكر اطفال</option>
                                        <option value="2">تذاكر كبار</option>
                                        <option value="2">تذاكر عائلية</option>
                                    </TextField>
                                </div>
